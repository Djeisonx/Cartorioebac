...
{
	//Inicio criação de variávesis/string
	char arquivo[40];
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	...
	printf("Digite o CPF a ser cadastrado: ");//Coletando infiormação do usuário
...
int main()
	...
	if(senhadigitada[10] == "Lvag30dje")
	{
      	...
      	for(laco=1;laco=1;)
	    {
            ...
            system("cls"); //responsávelpor limpar a tela
